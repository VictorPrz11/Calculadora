  ...
  return (
    ...
    <View style = {styles.calculatorContainer}>
        <View style = {{paddingHorizontal : 30, paddingBottom : 20}}>
            ...
            {
                (formula === prevNumber || formula === '') ? <Text style = {styles.subResult}></Text>:
            <Text adjustsFontSizeToFit numberOfLines={1} style = {styles.subResult}>{prevNumber}</Text>
            }
        </View>
      
        <View style= {styles.row}>
            <CalculatorButton onPress = {clean} label='C'   color = {colors.lightGray}/>
            <CalculatorButton onPress = {toggleSign} label='+/-' color = {colors.lightGray}/>
